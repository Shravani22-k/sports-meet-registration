...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  .topbar nav a{text-decoration:none; color:var(--text-muted); font-size:0.9rem; margin-left:24px; transition:color .2s;}
  .topbar nav a:hover{color:var(--text-light);}
...
<body>
  ...
  <header class="topbar">
    <a href="index.html" class="brand" style="text-decoration:none;"><span class="dot"></span> SPORTS MEET 2026</a>
    <nav>
  ...
  <main>
    ...
    <div class="confirm-wrap">
      ...
      <div class="actions">
        ...
        <a class="btn btn-ghost" href="register.html">Register another participant</a>
      </div>
    </div>
    <?php else: ?>
    <div class="empty-state">
      ...
      <a class="btn btn-primary" href="register.html">Go to registration form</a>
    </div>
    <?php endif; ?>
  </main>
